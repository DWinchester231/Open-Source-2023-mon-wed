package com.winchester.thecalculatorhub;

import com.winchester.project.utilities.Helpers;
...
@WebServlet(name="distanceConverter", urlPatterns = {"/convert-dis"})
public class DistanceConverter extends HttpServlet {

    Map<String, String> results = new HashMap<>();
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getRequestDispatcher("WEB-INF/day20/convert-dis.jsp").forward(req, resp);
    }
